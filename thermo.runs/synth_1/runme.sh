...
HD_PWD='C:/Users/praktykant2/workspace_vivado/thermo/thermo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ENT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ENT.tcl
